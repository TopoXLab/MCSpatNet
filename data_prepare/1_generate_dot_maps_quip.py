...
in_root_dir = '../../MCSpatNet_datasets/brca-m2c'
out_root_dir = '../../MCSpatNet_datasets/brca-m2c_cc'
# Define cell classes
classes_max_indx=3
...
"""
    This code assumes the input has the following format (which is generated by extraction from quip using the code in https://github.com/david-belinsky-sbu/Dataset_Tools ):
        - for each WSI, there is folder under <in_root_dir> with the slide name
...
if __name__ == "__main__":
    '''
        For each WSI, loop over the image patches and their labels, as follows: 
        For each image: 
    ...
    svs_list = glob.glob(os.path.join(in_root_dir, '*'))
